...
Challenge1: RDS failed to create — `Cannot find version 16.4 for postgres`.
Pinning an exact Postgres minor version broke since AWS had deprecated it.
Fixed by using `engine_version = "16"` instead — lets AWS pick the latest supported minor version automatically.
